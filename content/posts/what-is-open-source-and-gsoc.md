---
title: "What is Open Source and Google Summer of Code?"
date: 2024-05-23T14:00:00+05:30
draft: false
tags: ["GSoC", "Open Source", "Guide", "Students"]
categories: ["Open Source", "Guide"]
---

After I shared [my journey to GSoC](/posts/my-gsoc-journey/), many aspiring students reached out with the same questions: *What exactly is open source? What is GSoC? And how can I get started?*
...
*   Learn the basic Git commands: `clone`, `add`, `commit`, `push`, `pull`.
*   Understand the GitHub flow: Forking a repository, creating a new branch, opening a pull request.
*   There are tons of free resources on YouTube and websites like [freeCodeCamp](https://www.freecodecamp.org/news/git-and-github-for-beginners/) to learn this.
